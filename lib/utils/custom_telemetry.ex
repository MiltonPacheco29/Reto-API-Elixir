defmodule ApiAuth.Utils.CustomTelemetry do
  alias ApiAuth.Utils.DataTypeUtils
  alias ApiAuth.Utils.CustomTelemetry
  import Telemetry.Metrics
  require Logger

  @service_name Application.compile_env!(:api_auth, :custom_metrics_prefix_name)
  ...
  def handle_custom_event([:api_auth, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
