defmodule ApiAuth.Config.ConfigHolder do
  use GenServer
  alias ApiAuth.Config.AppConfig
  @table_name :api_auth_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:api_auth, :config_loaders, [])
...
defmodule ApiAuth.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias ApiAuth.Config.AppConfig
